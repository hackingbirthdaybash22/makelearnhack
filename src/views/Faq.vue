    ...
    <div id="questions">
      <div id="question" v-for="element in faq" :key="element.id">
        <div
          class="card"
          id="question"
          style="width: 60vw; margin: 0vh 10vw 2vh; text-align: left"
        >
          <div class="card-body">
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  form.addEventListener("submit", function (e) {
    ...
    const data = {
      ...
      inputs: [query],
      examples: [
        { text: "What is a hackathon?", label: "General" },
        { text: "How do new hackers join a hackathon?", label: "General" },
        {
          text: "What do new hackers need to know about hackathons?",
          label: "General",
        },
        {
          text: "What is needed to complete a hackathon project?",
          label: "General",
        },
        {
          text: "What is important about building proper hacks for hackathons?",
          label: "General",
        },
        { text: "Who is eligible to join hackathons?", label: "General" },
        {
          text: "What are the skills and competencies of a good hacker?",
          label: "Skills",
        },
        {
          text: "What is the quickest way to start hacking and learning how to hack?",
          label: "Skills",
        },
        {
          text: "What will I get out of hacking? How will hacking benefit me?",
          label: "Skills",
        },
        { text: "What is good hacker etiquette?", label: "Skills" },
        {
          text: "What are common tools for (remote) collaboration that would be good to learn?",
          label: "Skills",
        },
        { text: "Who is this website for?", label: "About" },
        { text: "What is this website for?", label: "About" },
        {
          text: "What made us (yes, us! the creators of this website) start hacking?",
          label: "About",
        },
        { text: "How has our hacking journey been so far?", label: "About" },
        { text: "How was this website built?", label: "About" },
      ],
    };
